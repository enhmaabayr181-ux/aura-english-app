...
const VOCAB = [
  ...
  },
  {
    ...
    words:[
      {ic:"😰", en:"Anxious", pron:"энгшэс", mn:"Түгшүүртэй"},
      {ic:"😁", en:"Joyful", pron:"жойфул", mn:"Баяр хөөртэй"},
      {ic:"😨", en:"Afraid", pron:"эфрэйд", mn:"Айсан"},
      {ic:"😕", en:"Confused", pron:"кэнфьюзд", mn:"Эргэлзсэн"},
      {ic:"😌", en:"Content", pron:"контэнт", mn:"Сэтгэл хангалуун"},
      {ic:"😖", en:"Miserable", pron:"мизэрэбл", mn:"Зовлонтой"},
      {ic:"😡", en:"Furious", pron:"фюриэс", mn:"Ихэд уурласан"},
      {ic:"🕊️", en:"Peaceful", pron:"пийсфул", mn:"Амар тайван"},
  ...
  },
  {
    ...
    words:[
      {ic:"⬆️", en:"Upload", pron:"аплоуд", mn:"Байршуулах"},
      {ic:"🌐", en:"Website", pron:"вэбсайт", mn:"Вэбсайт"},
      {ic:"📟", en:"Device", pron:"дивайс", mn:"Төхөөрөмж"},
      {ic:"📶", en:"Network", pron:"нэтвөрк", mn:"Сүлжээ"},
      {ic:"📊", en:"Data", pron:"дэйта", mn:"Өгөгдөл"},
      {ic:"🔍", en:"Search", pron:"сөрч", mn:"Хайх"},
      {ic:"👤", en:"Account", pron:"экаунт", mn:"Бүртгэл"},
      {ic:"🧭", en:"Browser", pron:"браузэр", mn:"Хөтөч"},
  ...
  },
  {
    ...
    words:[
      {ic:"🥗", en:"Diet", pron:"дайэт", mn:"Хоолны дэглэм"},
      {ic:"🏋️", en:"Exercise", pron:"эксэрсайз", mn:"Дасгал хөдөлгөөн"},
      {ic:"🩹", en:"Wound", pron:"вүнд", mn:"Шарх"},
      {ic:"🩸", en:"Blood", pron:"блад", mn:"Цус"},
      {ic:"🫁", en:"Breath", pron:"брэс", mn:"Амьсгаа"},
      {ic:"⚖️", en:"Weight", pron:"вэйт", mn:"Жин"},
      {ic:"💊", en:"Vitamin", pron:"витамин", mn:"Витамин"},
      {ic:"😵", en:"Dizzy", pron:"дизи", mn:"Толгой эргэх"},
  ...
  },
  {
    ...
    words:[
      {ic:"⏳", en:"Patient", pron:"пэйшэнт", mn:"Тэвчээртэй"},
      {ic:"🗣️", en:"Talkative", pron:"токэтив", mn:"Яриа хөөртэй"},
      {ic:"💪", en:"Hardworking", pron:"хардвөркинг", mn:"Хөдөлмөрч"},
      {ic:"🙇", en:"Modest", pron:"модэст", mn:"Даруу"},
      {ic:"😈", en:"Cruel", pron:"крүэл", mn:"Хэрцгий"},
      {ic:"🌞", en:"Optimistic", pron:"оптимистик", mn:"Өөдрөг"},
      {ic:"🥺", en:"Sensitive", pron:"сэнситив", mn:"Мэдрэмтгий"},
      {ic:"🎨", en:"Creative", pron:"криэйтив", mn:"Бүтээлч"},
  ...
  },
  {
    ...
    words:[
      {ic:"🤝", en:"Negotiate", pron:"нэгошиэйт", mn:"Хэлэлцээр хийх"},
      {ic:"🧑‍💼", en:"Client", pron:"клайэнт", mn:"Харилцагч"},
      {ic:"🧾", en:"Invoice", pron:"инвойс", mn:"Нэхэмжлэх"},
      {ic:"🗺️", en:"Strategy", pron:"стрэтэжи", mn:"Стратеги"},
      {ic:"🤝", en:"Partnership", pron:"партнэршип", mn:"Түншлэл"},
      {ic:"💼", en:"Investor", pron:"инвэстор", mn:"Хөрөнгө оруулагч"},
  ...
  },
  {
    ...
    words:[
      {ic:"📝", en:"Prescription", pron:"прискрипшн", mn:"Эмийн жор"},
      {ic:"💊", en:"Pharmacy", pron:"фармэси", mn:"Эмийн сан"},
      {ic:"🚨", en:"Emergency", pron:"имөрженси", mn:"Яаралтай тусламж"},
      {ic:"🏥", en:"Clinic", pron:"клиник", mn:"Эмнэлэг / клиник"},
      {ic:"🦽", en:"Wheelchair", pron:"вийлчэйр", mn:"Тэргэнцэр"},
      {ic:"💉", en:"Injection", pron:"инжэкшн", mn:"Тарилга"},
      {ic:"🔬", en:"Operation", pron:"опэрэйшн", mn:"Хагалгаа"},
      {ic:"🧘", en:"Therapy", pron:"сэрэпи", mn:"Эмчилгээ"},
  ...
  },
  {
    ...
    words:[
      {ic:"🖥️", en:"Hardware", pron:"хардвэр", mn:"Техник хангамж"},
      {ic:"🖨️", en:"Printer", pron:"принтэр", mn:"Хэвлэгч"},
      {ic:"📸", en:"Screenshot", pron:"скрийншот", mn:"Дэлгэцийн зураг"},
      {ic:"⚙️", en:"Install", pron:"инстол", mn:"Суулгах"},
      {ic:"🗑️", en:"Delete", pron:"дилийт", mn:"Устгах"},
      {ic:"💾", en:"Save", pron:"сэйв", mn:"Хадгалах"},
      {ic:"🖧", en:"Server", pron:"сөрвэр", mn:"Сервер"},
      {ic:"♻️", en:"Backup", pron:"бэкап", mn:"Нөөц хувь"},
  ...
  },
  {
    ...
    words:[
      {ic:"🙏", en:"Belief", pron:"билийф", mn:"Итгэл үнэмшил"},
      {ic:"📖", en:"Meaning", pron:"мийнинг", mn:"Утга учир"},
      {ic:"💎", en:"Value", pron:"вэлью", mn:"Үнэ цэнэ"},
      {ic:"🧠", en:"Concept", pron:"консэпт", mn:"Үзэл баримтлал"},
      {ic:"🦉", en:"Wisdom", pron:"виздэм", mn:"Мэргэн ухаан"},
      {ic:"🤨", en:"Doubt", pron:"даут", mn:"Эргэлзээ"},
      {ic:"🌈", en:"Hope", pron:"хоуп", mn:"Найдвар"},
      {ic:"🔑", en:"Solution", pron:"сэлюшн", mn:"Шийдэл"},
  ...
  },
  {
    ...
    words:[
      {ic:"⚖️", en:"Justice", pron:"жастис", mn:"Шударга ёс"},
      {ic:"🌍", en:"Reality", pron:"риэлити", mn:"Бодит байдал"},
      {ic:"🎴", en:"Fate", pron:"фэйт", mn:"Хувь заяа"},
      {ic:"🦁", en:"Courage", pron:"карэж", mn:"Зориг"},
      {ic:"🌟", en:"Fame", pron:"фэйм", mn:"Алдар нэр"},
      {ic:"💐", en:"Beauty", pron:"бьюти", mn:"Гоо сайхан"},
      {ic:"🦚", en:"Pride", pron:"прайд", mn:"Бахархал"},
      {ic:"🏅", en:"Reputation", pron:"рэпютэйшн", mn:"Нэр хүнд"},
  ...
  },
  {
    ...
    words:[
      {ic:"🎤", en:"Lecture", pron:"лэкчэр", mn:"Лекц"},
      {ic:"🎓", en:"Scholarship", pron:"сколэршип", mn:"Тэтгэлэг"},
      {ic:"🎓", en:"Graduate", pron:"грэжуэйт", mn:"Төгсөх"},
      {ic:"📋", en:"Curriculum", pron:"карикюлэм", mn:"Хөтөлбөр"},
      {ic:"🏫", en:"Classroom", pron:"класрүм", mn:"Анги"},
      {ic:"📜", en:"Diploma", pron:"дипломэ", mn:"Диплом"},
      {ic:"📆", en:"Semester", pron:"симэстэр", mn:"Улирал / семестр"},
      {ic:"💰", en:"Tuition", pron:"түишн", mn:"Сургалтын төлбөр"},
  ...
  },
  {
    ...
    words:[
      {ic:"📈", en:"Inflation", pron:"инфлэйшн", mn:"Инфляц"},
      {ic:"🏬", en:"Market", pron:"маркэт", mn:"Зах зээл"},
      {ic:"📦", en:"Supply", pron:"сэплай", mn:"Нийлүүлэлт"},
      {ic:"🙋", en:"Demand", pron:"димэнд", mn:"Эрэлт"},
      {ic:"🚢", en:"Export", pron:"экспорт", mn:"Экспорт"},
      {ic:"🛳️", en:"Import", pron:"импорт", mn:"Импорт"},
      {ic:"🏭", en:"Industry", pron:"индастри", mn:"Аж үйлдвэр"},
      {ic:"📉", en:"Recession", pron:"рисэшн", mn:"Эдийн засгийн хямрал"},
  ...
  },
  {
    ...
    words:[
      {ic:"🧬", en:"Molecule", pron:"молэкюл", mn:"Молекул"},
      {ic:"📐", en:"Theory", pron:"сиэри", mn:"Онол"},
      {ic:"🔎", en:"Research", pron:"рисөрч", mn:"Судалгаа"},
      {ic:"🧬", en:"Gene", pron:"жийн", mn:"Ген"},
      {ic:"🧊", en:"Solid", pron:"солид", mn:"Хатуу бие"},
      {ic:"🔬", en:"Microscope", pron:"майкроскоуп", mn:"Микроскоп"},
      {ic:"🌌", en:"Galaxy", pron:"гэлэкси", mn:"Галактик"},
      {ic:"⚗️", en:"Reaction", pron:"риэкшн", mn:"Урвал"},
  ...
  },
  {
    ...
    words:[
      {ic:"💍", en:"Engagement", pron:"энгэйжмэнт", mn:"Сүй тавилт"},
      {ic:"💔", en:"Divorce", pron:"диворс", mn:"Гэр бүл салалт"},
      {ic:"🤞", en:"Loyalty", pron:"лойэлти", mn:"Үнэнч байдал"},
      {ic:"💗", en:"Affection", pron:"эфэкшн", mn:"Хайр энэрэл"},
      {ic:"🤙", en:"Commitment", pron:"комитмэнт", mn:"Амлалт үүрэг"},
      {ic:"😒", en:"Jealousy", pron:"жэлэси", mn:"Атаархал"},
      {ic:"🧑‍🤝‍🧑", en:"Companion", pron:"компэнион", mn:"Хамтрагч"},
      {ic:"🔗", en:"Bond", pron:"бонд", mn:"Дотно холбоо"},
  ...
  },
  {
    ...
    words:[
      {ic:"🤞", en:"Loyal", pron:"лойэл", mn:"Үнэнч"},
      {ic:"😤", en:"Arrogant", pron:"эрэгэнт", mn:"Их зантай"},
      {ic:"🙏", en:"Humble", pron:"хамбл", mn:"Даруу"},
      {ic:"🤗", en:"Caring", pron:"кэринг", mn:"Халамжтай"},
      {ic:"👊", en:"Aggressive", pron:"эгрэсив", mn:"Түрэмгий"},
      {ic:"✅", en:"Responsible", pron:"риспонсибл", mn:"Хариуцлагатай"},
      {ic:"🕊️", en:"Tolerant", pron:"толэрэнт", mn:"Хүлээцтэй"},
      {ic:"💯", en:"Sincere", pron:"синсиэр", mn:"Чин сэтгэлийн"},
  ...
  },
  {
    ...
    words:[
      {ic:"🕗", en:"Overtime", pron:"оувэртайм", mn:"Илүү цаг"},
      {ic:"🔄", en:"Shift", pron:"шифт", mn:"Ээлж"},
      {ic:"🗓️", en:"Schedule", pron:"скэжюл", mn:"Хуваарь"},
      {ic:"🙋", en:"Applicant", pron:"эпликэнт", mn:"Горилогч"},
      {ic:"📄", en:"Resume", pron:"рэзюмэй", mn:"Намтар (CV)"},
      {ic:"👴", en:"Retire", pron:"ритайэр", mn:"Тэтгэвэрт гарах"},
      {ic:"📚", en:"Workload", pron:"вөрклоуд", mn:"Ажлын ачаал"},
      {ic:"🎁", en:"Bonus", pron:"боунэс", mn:"Урамшуулал"},
  ...
  },
  {
    ...
    words:[
      {ic:"🐖", en:"Savings", pron:"сэйвингз", mn:"Хадгаламж"},
      {ic:"📈", en:"Interest", pron:"интрэст", mn:"Хүү"},
      {ic:"🏧", en:"Withdraw", pron:"виздро", mn:"Данснаас мөнгө авах"},
      {ic:"🏦", en:"Deposit", pron:"дипозит", mn:"Дансанд мөнгө хийх"},
      {ic:"💱", en:"Currency", pron:"карэнси", mn:"Валют"},
      {ic:"💎", en:"Wealth", pron:"вэлс", mn:"Эд баялаг"},
      {ic:"📉", en:"Bankrupt", pron:"бэнкрапт", mn:"Дампуурсан"},
      {ic:"🏠", en:"Mortgage", pron:"моргэж", mn:"Барьцаа зээл"},
  ...
  },
  {
    ...
    words:[
      {ic:"👥", en:"Audience", pron:"одиэнс", mn:"Үзэгчид"},
      {ic:"📢", en:"Advertisement", pron:"эдвөртисмэнт", mn:"Сурталчилгаа"},
      {ic:"✏️", en:"Editor", pron:"эдитэр", mn:"Редактор"},
      {ic:"🎤", en:"Reporter", pron:"рипортэр", mn:"Сурвалжлагч"},
      {ic:"🎧", en:"Podcast", pron:"подкаст", mn:"Подкаст"},
      {ic:"🔔", en:"Subscribe", pron:"сэбскрайб", mn:"Бүртгүүлэх"},
      {ic:"🖨️", en:"Publish", pron:"паблиш", mn:"Нийтлэх"},
      {ic:"🎙️", en:"Interview", pron:"интэрвью", mn:"Ярилцлага"},
  ...
  },
  {
    ...
    words:[
      {ic:"🎗️", en:"Cancer", pron:"кэнсэр", mn:"Хорт хавдар"},
      {ic:"🩸", en:"Diabetes", pron:"дайэбитийз", mn:"Чихрийн шижин"},
      {ic:"🔴", en:"Rash", pron:"рэш", mn:"Тууралт"},
      {ic:"🤢", en:"Nausea", pron:"нозиа", mn:"Дотор муухайрах"},
      {ic:"😩", en:"Fatigue", pron:"фэтийг", mn:"Ядаргаа"},
      {ic:"🦠", en:"Contagious", pron:"контэйжэс", mn:"Халдварт"},
      {ic:"⏳", en:"Chronic", pron:"кроник", mn:"Архаг"},
      {ic:"🛡️", en:"Immune", pron:"имюн", mn:"Дархлаа"},
